import allReferralSheetFormPd from './allReferralSheetFormPd.html';
import './allReferralSheetPd.less';

angular.module('app')
    .component('allReferralSheetFormPd', {
        template: allReferralSheetFormPd,
        controller: allReferralSheetFormPDCtrl,
        controllerAs: '$ctrl'
    });

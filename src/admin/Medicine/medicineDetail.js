...
function SystemMedicineDetailCtrl($state, $stateParams, $mdDialog, medicineService, showMessage, $filter) {
    ...
    vm.Frequencys = {
        ...
        QDAC: $translate('medicine.component.MedQDAC'), // lang.MedQDAC,
        ...
        //QHD: $translate('medicine.component.MedQHD'), // lang.MedQHD,
        PRN: $translate('medicine.component.MedPRN'), // lang.MedPRN,
        ST: $translate('medicine.component.MedST') // lang.MedST,
    };

import templateA from './summaryA.component.html'; // 系統設定 選項B 圖檔 formA.jpg
import './summaryA.component.less';

angular.module('app').component('summaryA', {
    bindings: {
        headerId: '<',
        patient: '<',
        // deviation: '<',
...
SummaryAController.$inject = ['$stateParams', 'summaryReportService', 'SettingService'];

function SummaryAController($stateParams, summaryReportService, SettingService) {
